...
VAR MallLocations = (Mall, BraStore, BookStore, DressStore, FoodCourt, MovieTheater, ShoeStore, DressingRoom)
...
- StudyHall:
    { what:
        ...
        - LocationClassName: { now == AfterSchool:
                ~ return STUDY_HALL_CLASS_NAME
            - else:
                ~ return DETENTION_NAME
            }
